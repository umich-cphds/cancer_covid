...
if (getwd() != "/net/wonderland/home/mmsalva/projects/covid/new_cancer") {
  setwd("/net/wonderland/home/mmsalva/projects/covid/new_covid")
}
...
comorbs <- c("AnyCancerPhe", "AnyCancer", "RespiratoryDiseases", "CirculatoryDiseases", "Type2Diabetes", "KidneyDiseases", "LiverDiseases", "AutoimmuneDiseases")
...
labels <- list(
  variables =
    list(
      ...
      RaceEthnicity4           = "Race/ethnicity",
      popden13_17_qrtl         = "Population density (qrtl)",
      disadvantage2_13_17_qrtl = "Disadvantage (qrtl)",
      affluence13_17_qrtl      = "Affluence (qrtl)",
      ethnicimmigrant13_17_qrtl = "Ethnic/Immigrant (qrtl)",
      ped1_13_17_qrtl          = "PED1 (qrtl)",
      ComorbidityScore         = "Comorbidity score",
      AnyCancerPhe             = "Any cancer",
      AnyCancer                = "Any cancer (Lars variable)"
      ))
...
strata <- c(list(Overall = unmatched),
            split(unmatched, unmatched$AnyCancerPhe))
